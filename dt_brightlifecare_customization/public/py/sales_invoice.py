...
def before_submit(doc, method):
    validate_reserve_stock_against_sales_invoice(doc, method)



def validate_reserve_stock_against_sales_invoice(doc, method):

    mrp_settings = frappe.get_single("MRP Settings")
    if mrp_settings.validate_reserve_stock_against_sales_invoice == 0:
        return
